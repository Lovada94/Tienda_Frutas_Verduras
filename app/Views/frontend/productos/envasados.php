...
<div class="d-flex">
    ...
    <aside class="flex-shrink-0 bg-body-tertiary border-start p-4 sidebar-right">
        <div class="sticky-side">
            ...
            <hr>
            <ul class="nav nav-pills flex-column gap-2">
                <li><a href="<?= base_url('envasados') ?>?sort=nombre&dir=asc" class="nav-link link-body-emphasis">Nombre</a></li>
                <li><a href="<?= base_url('envasados') ?>?sort=precio&dir=asc" class="nav-link link-body-emphasis">Precio Ascendente</a></li>
                <li><a href="<?= base_url('envasados') ?>?sort=precio&dir=desc" class="nav-link link-body-emphasis">Precio Descendente</a></li>
                <li><a href="<?= base_url('envasados') ?>?sort=n_ventas&dir=desc" class="nav-link link-body-emphasis">Nº de Ventas</a></li>
            </ul>
        </div>
    </aside>
