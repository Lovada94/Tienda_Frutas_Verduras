...
<div class="d-flex">
        ...
        <div class="container my-4">
            <section class="py-4">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 justify-content-center">
                    <?php foreach ($verduras as $producto): ?>
                        <div class="col">
                            <div class="card shadow-sm h-100">
                                ...
                                <img
                                    class="card-img-top"
                                    src="<?= base_url('assets/img/fruta_verdura/' . $producto['imagen']) ?>"
    ...
    <aside class="flex-shrink-0 bg-body-tertiary border-start p-4 sidebar-right">
        <div class="sticky-side">
            ...
            <hr>
            <ul class="nav nav-pills flex-column gap-2">
                <li><a href="<?= base_url('verduras') ?>?sort=nombre&dir=asc" class="nav-link link-body-emphasis">Nombre</a></li>
                <li><a href="<?= base_url('verduras') ?>?sort=precio&dir=asc" class="nav-link link-body-emphasis">Precio Ascendente</a></li>
                <li><a href="<?= base_url('verduras') ?>?sort=precio&dir=desc" class="nav-link link-body-emphasis">Precio Descendente</a></li>
                <li><a href="<?= base_url('verduras') ?>?sort=n_ventas&dir=desc" class="nav-link link-body-emphasis">Nº de Ventas</a></li>
            </ul>
        </div>
    </aside>
